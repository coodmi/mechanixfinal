...
class CareersQuoteController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('admin/careers-quote', [
            'quote' => [
                'text' => $content->quote ?? '',
    ...
    public function update(Request $request)
    {
        ...
        AdminActivity::log('updated', 'PageSection', $section->id, null, 'Updated careers page quote section');
