...
class LifeAtMechanixQuoteController extends Controller
{
    public function index()
    {
        $section = PageSection::firstOrCreate(
            ['section_key' => 'page_hero', 'page' => 'life-at-mechanix'],
            ['is_active' => true, 'order' => 0]
        );

        $content = $section->getContentObject();

        return Inertia::render('admin/life-at-mechanix-quote', [
            'quote' => [
                'text' => $content->quote ?? '',
    ...
    public function update(Request $request)
    {
        ...
        AdminActivity::log('updated', 'PageSection', $section->id, null, 'Updated life at mechanix page quote section');
