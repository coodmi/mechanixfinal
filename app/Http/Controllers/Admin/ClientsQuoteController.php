...
class ClientsQuoteController extends Controller
{
    public function index()
    {
        $section = PageSection::firstOrCreate(
            ['section_key' => 'page_hero', 'page' => 'clients'],
            ['is_active' => true, 'order' => 0]
        );

        $content = $section->getContentObject();

        return Inertia::render('admin/clients-quote', [
            'quote' => [
                'text' => $content->quote ?? '',
    ...
    public function update(Request $request)
    {
        ...
        // Map 'text' to 'quote' for consistency with existing structure
        ...
        AdminActivity::log('updated', 'PageSection', $section->id, null, 'Updated clients page quote section');
