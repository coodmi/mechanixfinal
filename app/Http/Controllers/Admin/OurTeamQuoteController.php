...
class OurTeamQuoteController extends Controller
{
    public function index()
    {
        $section = PageSection::firstOrCreate(
            ['section_key' => 'page_hero', 'page' => 'our-team'],
            ['is_active' => true, 'order' => 0]
        );

        $content = $section->getContentObject();

        return Inertia::render('admin/our-team-quote', [
            'quote' => [
                'text' => $content->quote ?? '',
    ...
    public function update(Request $request)
    {
        ...
        AdminActivity::log('updated', 'PageSection', $section->id, null, 'Updated our team page quote section');
