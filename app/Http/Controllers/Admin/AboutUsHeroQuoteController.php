...
class AboutUsHeroQuoteController extends Controller
{
    public function index()
    {
        $section = PageSection::firstOrCreate(
            ['section_key' => 'page_hero', 'page' => 'about-us'],
    ...
    public function update(Request $request)
    {
        ...
        AdminActivity::log('updated', 'PageSection', $section->id, null, 'Updated about us page hero quote section');
